...
void main() {
  group('AuthValidator Password Tests', () {
    test('throws PasswordValidationException if password is null', () {
      expect(
        ...
        throwsA(isA<PasswordValidationException>()),
      );
    });
    ...
    test(
      'throws PasswordValidationException if password is too short (<12 chars)',
      () {
        expect(
          () => AuthValidator.validatePassword('ShortPass1!'),
          throwsA(isA<PasswordValidationException>()),
        );
      },
    );
    ...
    test(
      'throws PasswordValidationException if password is a common password',
      () {
        ...
        expect(
          () => AuthValidator.validatePassword('123456789012'),
          throwsA(isA<PasswordValidationException>()),
        );
      },
    );
    ...
    test(
      'throws PasswordValidationException if password contains sequential patterns',
      () {
        expect(
          () => AuthValidator.validatePassword('abcdefghijkl'),
          throwsA(isA<PasswordValidationException>()),
        );
        expect(
          () => AuthValidator.validatePassword('123456789012'),
    ...
    test(
      'throws PasswordValidationException if password contains repetitive characters',
      () {
        expect(
          () => AuthValidator.validatePassword('aaaaaaaaaaaa'),
          throwsA(isA<PasswordValidationException>()),
        );
        expect(
          () => AuthValidator.validatePassword('111111111111'),
          throwsA(isA<PasswordValidationException>()),
        );
      },
    );
    ...
    test('validates strong password successfully', () {
      expect(
        () => AuthValidator.validatePassword('CorrectHorseBatteryStaple'),
        returnsNormally,
      );
      expect(
        () => AuthValidator.validatePassword('MyDogIsFluffyToday'),
        returnsNormally,
      );
      expect(
        () => AuthValidator.validatePassword('Th1sIs@V3ryG00dP@ssw0rd'),
        returnsNormally,
      );
    });
  });
  ...
  group('AuthValidator Email Tests', () {
    ...
    test('throws InvalidCredentialsException if email format is invalid', () {
      ...
      expect(
        () => AuthValidator.validateEmail('@domain.com'),
        throwsA(isA<InvalidCredentialsException>()),
      );
    });
    ...
    test('validates correct email successfully', () {
      ...
      expect(
        () => AuthValidator.validateEmail('user.name@domain.co.uk'),
        returnsNormally,
      );
    });
  });
