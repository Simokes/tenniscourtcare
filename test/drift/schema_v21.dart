...
class Terrains extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Terrains(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumn<String> status = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('\'playable\''),
  );
  ...
  @override
  Terrains createAlias(String alias) {
    return Terrains(attachedDatabase, alias);
  }
}

class Maintenances extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Maintenances(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  Maintenances createAlias(String alias) {
    return Maintenances(attachedDatabase, alias);
  }
}

class StockItems extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StockItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  StockItems createAlias(String alias) {
    return StockItems(attachedDatabase, alias);
  }
}
...
class Users extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> status = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('\'inactive\''),
  );
...
class Events extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> terrainIds = GeneratedColumn<String>(
    'terrain_ids',
    aliasedName,
    false,
    type: DriftSqlType.string,
...
class LoginAttempts extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LoginAttempts(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  LoginAttempts createAlias(String alias) {
    return LoginAttempts(attachedDatabase, alias);
  }
}

class OtpRecords extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OtpRecords(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  OtpRecords createAlias(String alias) {
    return OtpRecords(attachedDatabase, alias);
  }
}
...
class DatabaseAtV21 extends GeneratedDatabase {
  ...
  DatabaseAtV21.connect(DatabaseConnection c) : super.connect(c);
  late final Terrains terrains = Terrains(this);
  late final Maintenances maintenances = Maintenances(this);
  late final StockItems stockItems = StockItems(this);
  ...
  late final LoginAttempts loginAttempts = LoginAttempts(this);
  late final OtpRecords otpRecords = OtpRecords(this);
